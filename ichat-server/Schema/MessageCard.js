...
const messageCardSchema = new mongoose.Schema({
    receiver_id: { type: mongoose.Schema.Types.ObjectId, ref: 'UserInfo', required: true }, // Người nhận
    message_id: { type: mongoose.Schema.Types.ObjectId, ref: 'Messages', required: true }, // Tin nhắn liên quan
    status: { type: String, enum: ["unread", "read"], required: true, default: "unread" }, // Trạng thái tin nhắn
