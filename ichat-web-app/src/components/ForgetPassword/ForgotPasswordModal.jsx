...
import { sendOtpFirebase, verifyOtpFirebase, resetPassword } from '../../redux/slices/authSlice';
...
const ForgotPasswordModal = ({ visible, onClose }) => {
    ...
    const handlePhoneSubmit = async () => {
        ...
        if (!parsedPhone || !parsedPhone.isValid()) return alert('Số điện thoại không hợp lệ');
    ...
    const handlePasswordReset = async () => {
        ...
        const parsedPhone = parsePhoneNumberFromString(phone, countryCode);
        const result = await dispatch(resetPassword({ phone: parsedPhone.number, newPassword }));
    ...
    return (
        <div className="modal-overlay">
            <div className="modal forgot-modal">
                ...
                }} className="close-btn" onClick={onClose}>X</button>
                <img style={{
                    width: "150px",
                    height: "auto"
                ...
                {step === 1 && (
                    <>
                        ...
                        <button style={{ width: "80%", alignSelf: "center" }} onClick={handlePhoneSubmit}>Gửi mã OTP</button>
                    </>
                )}
                ...
                {step === 2 && (
                    <>
                        ...
                        <div style={{ display: "flex", flexDirection: "column-reverse", gap: "10px" }} >
                            ...
                            <button style={{ width: "80%", alignSelf: "center" }} onClick={handleOtpSubmit}>Xác nhận OTP</button>
                ...
                {step === 3 && (
                    <>
                        ...
                        <div style={{ display: "flex", flexDirection: "column-reverse", gap: "10px" }}>
                            <button style={{ width: "40%", alignSelf: "center", borderRadius: "20px 0 0 20px" }} onClick={handlePreviousStep}>Quay lại</button>
                            <button style={{ width: "80%", alignSelf: "center" }} onClick={handlePasswordReset}>Tạo mật khẩu mới</button>
